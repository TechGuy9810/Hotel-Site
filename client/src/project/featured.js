  ...
  {loading ? (<div  style={{display:"flex",justifyContent:"center",alignItems:"center"}}><BeatLoader/></div>):(error?(toast.error("Error Loading Hotels")):(
    ...
    {data.map((item)=>(
        ...
        <div class="card-body">
          ...
          <div style={{display:"flex",justifyContent:"space-between",fontWeight:"500"}}><a class="btn btn-danger" id={item.city} name={item.country} onClick={event=>handleClick(event)}>View Now</a>
