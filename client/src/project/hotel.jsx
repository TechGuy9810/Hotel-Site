...
<div className="hotelWrapper">
  <div className="hotelImage">
    ...
    <img class="card-img-top" src={`/Image/${roomData.img[1]}`} alt="Card image cap"/>
    </div>
<div className="hotelImagePreview">
  {roomData.img.map((PreviewImage)=>{
    ...
    <img class="card-img-top" src={`/Image/${PreviewImage}`} alt="Card image cap" onClick={()=>setShowImageCarousel(`/Image/${PreviewImage}`)}/>
    </div>
    </>
    )
  })}
...
showImageCarousel&&(
  ...
  <img class="card-img-top" src={`${showImageCarousel}`} alt="Card image cap"/>
